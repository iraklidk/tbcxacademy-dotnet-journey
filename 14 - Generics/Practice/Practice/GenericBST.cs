namespace Practice
{
    ...
    public class GenericBST<T> where T : IComparable<T>
    {
        ...
        public Node<T> SearchDFS(Node<T> root, T value)
        {
            ...
            {
                return SearchDFS(root.Left, value);
            }
            else
            {
                return SearchDFS(root.Right, value);
            }
        }
        ...
        private Node<T> DeleteDFS(Node<T> root, T value)
        {
            ...
            if(root.Value.CompareTo(value) == 0)
            {
                ...
                Node<T> minNode = GetMinNode(root.Right); // get right subtrees minimum node
